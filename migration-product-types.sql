-- Product Type Categories Migration Script
-- Run this in your Supabase SQL Editor to add product type functionality
...
-- 2. Create product_types table for reference
...
-- 3. Insert predefined product types (will skip if already exists)
...
-- 4. Create index on product_type for better performance
CREATE INDEX IF NOT EXISTS idx_products_product_type ON products(product_type);

-- 5. Update existing products to have 'other' as default product_type
